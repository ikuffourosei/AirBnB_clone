...
class TestBaseModel(unittest.TestCase):
    ...
    def test_BaseModel_datetime_created(self):
    ...
    def test_BaseModel_id(self):
        ...
        value = [BaseModel().id for i in range(1000)]
    ...
    def test_BaseModel_to_dict_excess_args(self):
    ...
    def test_BaseModel_save_excess_args(self):
